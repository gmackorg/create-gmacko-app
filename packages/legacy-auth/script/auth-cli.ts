 ...
 * `pnpx @better-auth/cli generate --config script/auth-cli.ts --output ../legacy-db/src/auth-schema.ts`
 *
...
export const auth = initAuth({
  ...
  secret: "secret",
  githubClientId: "dev-github-client",
  githubClientSecret: "dev-github-secret",
  googleClientId: "dev-google-client",
  googleClientSecret: "dev-google-secret",
  appleClientId: "com.gmacko.dev",
  appleClientSecret: "dev-apple-secret",
