...
echo "Run 'pnpm db:migrate:local && pnpm db:seed' to set up the local D1 (apps/web)."
echo "Run 'pnpm db:legacy:push' to initialize the legacy Postgres schema (apps/nextjs, until Phase 8)."
