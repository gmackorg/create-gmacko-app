...
> Legacy note: this plan reflects the earlier Neon-first and Vercel-era template direction. The current template direction is ForgeGraph-managed deployments, Nix-based runtime definitions, and Postgres deployed alongside the app first.
